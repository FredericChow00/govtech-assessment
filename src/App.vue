<template>
  ...
  <div>
    ...
    <LocationInfo :selectedDateTime="this.selectedDateTime" @getLocation="handleLocation"/>
    <CameraPhoto: :selectedLocation="this.selectedLocation"/>
    <WeatherInfo: :selectedLocation="this.selectedLocation" :weather="this.weather" @getWeather="handleWeather"/>
  </div>
</template>
